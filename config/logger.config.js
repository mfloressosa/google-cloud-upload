...
exports.LOGGER_CONFIG = {
    appenders: {
        ...
        'GoogleCloudUpload': GetFileAppender('GoogleCloudUpload', true, false),
    },
    categories: {
        'default': GetCategory('GoogleCloudUpload', 'DEBUG', true),
        'Console': GetCategory('Console', 'DEBUG', true),
        'Error': GetCategory('Error', 'DEBUG', true),
        'GoogleCloudUpload': GetCategory(['GoogleCloudUpload', 'Console'], 'DEBUG', true),
    },
    pm2: false,
